...
//        this.addRenderLayer(new WaveforceTowerWaveforceLayer(this));
    ...
    @Override
    public void preRender(PoseStack poseStack, WaveforceTowerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(WaveforceTowerEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
