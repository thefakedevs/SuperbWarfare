...
public class ModItems {
    ...
    public static final RegistryObject<Item> UN_HELMET_PRESS = ITEMS.register("un_helmet_press", UnHelmetPress::new);
    public static final RegistryObject<Item> UN_CHEST_PRESS = ITEMS.register("un_chest_press", UnChestPress::new);
